...
import Deepargh from "./Deepargh.png"
import Supantha from "./Supantha.png"
import No from "./No.png"
import logo from "./Quest.ly.png"
  ...
  return (
   <div className={classes.root} >
      <Grid container spacing={3}>
        <Grid item xs={4}>
            <img src={logo} alt={"Questly Logo"} className={classes.the_Boys}/>
        </Grid>
        <Grid item xs={1}>
        ...
        <Grid item xs={4}>
          ...
          <img src={Supantha} alt={"no"} className={classes.the_Boys}/>
        ...
        <Grid item xs={4}>
          ...
          <img src={Deepargh} alt={"no"} className={classes.the_Boys}/>
          <Typography variant={"h6"}>
        ...
        <Grid item xs={4}>
          ...
          <img src={No} alt={"no"} className={classes.the_Boys}/>
          <Typography variant={"h6"}>
            Varun A. Vyas<br/>
          </Typography>
            <Typography variant="caption">
